...
public class Contact {
	...
	Contact() {
		...
		this.streetAddress = INITIALIZER;
	} 
	 ...
	 Contact(String contactId, String firstName, String lastName, String phoneNumber, String streetAddress) {
	    updateContactId(contactId);
	    updateFirstName(firstName);
	    updateLastName(lastName);
	    updatePhoneNumber(phoneNumber);
	  ...
	  protected final String getAddress() { return streetAddress; }
